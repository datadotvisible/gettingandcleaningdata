...
Data source
-----------
Dataset is created from the "Human Activity Recognition Using Smartphones Data Set" can be downloaded from http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones or from this repo.

Feature Selection 
-----------------
The description from the above dataset regarding features.
